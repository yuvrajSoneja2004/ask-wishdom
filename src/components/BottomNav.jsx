...
import { AiOutlineBell, AiOutlineCompass, AiOutlineHome, AiOutlineQuestionCircle, AiOutlineTeam } from 'react-icons/ai';
...
function BottomNav() {
    ...
    const handleDataFromChild = (childData) => {
        ...
        console.log("this is from bottom nav" ,  childData);
      }
    ...
    return (
        ...
        <Whole>
            ...
            <Bx>
                <Bubble>
                    <span className='notificationsCounter'>{notificationsCountConst?.length}</span>
                    <AiOutlineBell onClick={handleShow} size={ICON_SIZE} fill='#000'/>
                    <Notifications show={show} handleClose={handleClose} handleDataFromChild={handleDataFromChild}/>
                </Bubble>
            </Bx>
            <Bx to={"/myProfile/:userEmail"}>
                <Bubble>
                    <div className='userProfile'>
                    <img src={ getCurrentUserProfileData === null ? UserIcon : getCurrentUserProfileData[0]?.userProfilePic || UserIcon} alt="" />
                    </div>
                </Bubble>
            </Bx>
        </Whole>
